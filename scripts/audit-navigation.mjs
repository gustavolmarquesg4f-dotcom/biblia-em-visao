...
const requiredRoutes = ["/", "/comece", "/66-livros", "/livro/:bookId", "/roteiro", "/linha-do-tempo", "/atlas", "/historia", "/pessoas", "/temas", "/busca", "/mesa", "/canon", "/apocrifos", "/glossario", "/apocalipse", "/bibliografia", "/igreja", "/eclesiologia"];
const checks = {
  ...
  churchDeepEntry: app.includes('function ChurchEntry') && app.includes('initialDeepStudyId="o-que-e-ser-igreja"'),
  churchRouteAliases: command.includes('"/eclesiologia": "/igreja"') && home.includes('"/igreja": "studies"'),
