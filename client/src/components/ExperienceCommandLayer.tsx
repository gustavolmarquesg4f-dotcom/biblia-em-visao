...
const destinations: Destination[] = [
  ...
  { label: "Estudos profundos", detail: "Escatologia, Espírito, Igreja, finanças e temas", href: "/estudos-profundos", icon: Layers3, keywords: "estudo escatologia espírito anjos trindade finanças igreja eclesiologia corpo de Cristo corpo diaconal diácono diáconos diaconato pastor pastoral pastores evangelista evangelistas evangelismo dons ministério missão comunhão" },
  { label: "Igreja: corpo e ministérios", detail: "Eclesiologia profunda, dons, diaconato, pastorado e missão", href: "/igreja", icon: UsersRound, keywords: "igreja eclesiologia corpo de Cristo povo de Deus comunidade do Espírito diaconal diácono diáconos diaconato pastoral pastor pastores evangelista evangelistas evangelismo dons vocação autoridade missão cuidado" },
