...
import { ArrowRight, Check, CircleDashed, FileText, Layers3, MapPinned, ShieldCheck } from "lucide-react";
...
export default function StudyCoverageBoard({ openBook }: { openBook: (book: Book) => void }) {
