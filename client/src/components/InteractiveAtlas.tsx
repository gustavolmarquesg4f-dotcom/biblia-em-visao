...
function AtlasPlateArt({ plate }: { plate: AtlasPlate }) {
  ...
  if (plate.image && !imageFailed) return <img src={plate.image} alt={`Prancha cartográfica: ${plate.title}`} onError={() => setImageFailed(true)} />;
