...
export const atlasPlates: AtlasPlate[] = [
  { id: "origins", index: "01", era: "Origens · Bronze", title: "Do Nilo aos grandes rios", description: "Leia Gênesis no corredor que conecta Egito, Levante e Mesopotâmia; as rotas são orientações de leitura, não uma localização comprovada de cada cena.", image: atlasAsset("atlas-master-origins_8dc8764c.webp"), layerIds: ["patriarchs"], period: "Bronze", focus: { lat: 32.4, lng: 40.2 }, zoom: 5, source: { label: "Pleiades · Gazetteer de lugares antigos", url: "https://pleiades.stoa.org/places" } },
