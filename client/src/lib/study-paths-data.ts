...
export const studyPaths: StudyPath[] = [
  ...
  },
  {
    id: "o-que-e-ser-igreja", number: "20", category: "Eclesiologia · corpo e missão", title: "O que é ser Igreja?", lede: "Uma formação teológica em quatorze módulos sobre a Igreja como povo de Deus, corpo de Cristo, comunidade do Espírito e enviada ao mundo — com funções diaconais, pastorais e evangelísticas sem transformar serviço em hierarquia de prestígio.", question: "Como a Igreja permanece fiel a Cristo quando reúne adoração, doutrina, cuidado, liderança, dons, justiça, missão e responsabilidade diante de pessoas reais?", methodologicalNote: "Começa nos textos bíblicos, distingue descrição e prescrição, compara tradições católica, reformada, wesleyana, pentecostal e ecumênica, e trata cargos, dons, vocações e estruturas com prestação de contas e proteção contra abuso.", tags: ["Igreja", "corpo de Cristo", "diáconos", "pastores", "evangelistas", "missão", "dons"], destination: "studies", destinationLabel: "Continuar estudos profundos", steps: [
      ...
      { title: "Ler Israel, promessa e nova humanidade", references: "Êxodo 19 · Isaías 2 · Romanos 9–11 · Efésios 2", summary: "Relacionar a identidade da Igreja à história de Israel e à entrada dos povos, rejeitando supersessionismo, nacionalismo teológico e apagamento das diferenças." },
      ...
      { title: "Formar anciãos, mestres e ministérios", references: "Efésios 4 · Atos 14 · Atos 20 · 1 Timóteo 5", summary: "Entender ministérios como dons para equipar o corpo, unindo estudo bíblico, caráter, reconhecimento comunitário e multiplicação de servos." },
      ...
      { title: "Praticar Palavra, batismo, mesa e comunhão", references: "Atos 2:42–47 · 1 Coríntios 10–11 · Efésios 5", summary: "Relacionar ensino, batismo, Ceia, oração, cântico, mutualidade e cuidado para que a confissão da Igreja tenha forma visível." },
      { title: "Ser Igreja na cidade e no mundo", references: "Mateus 28 · Atos 1:8 · Tiago 2 · 2 Coríntios 5", summary: "Relacionar adoração, discipulado, evangelização, justiça, hospitalidade, ecumenismo e responsabilidade social na presença pública da Igreja." },
      { title: "Praticar santidade e cuidado dos vulneráveis", references: "Miqueias 6 · Isaías 58 · Tiago 1–2 · Gálatas 6", summary: "Testar se a santidade da comunidade protege pessoas, combate favoritismos, enfrenta violência e transforma compaixão em políticas e cuidado." },
      { title: "Avaliar saúde eclesial e caminhos de reforma", references: "Apocalipse 2–3 · 1 Tessalonicenses 5 · 1 Coríntios 11", summary: "Construir critérios de saúde que unam Cristo, Escritura, fruto, participação, transparência, proteção, missão e capacidade de receber correção." },
      { title: "Ouvir grandes teólogos e confissões em diálogo", references: "Agostinho · Calvino · Wesley · Bonhoeffer · Congar · Moltmann · Volf · Lausanne", summary: "Comparar corpo místico, ofícios, santidade social, vida comum, Espírito, esperança, comunhão e missão sem apagar diferenças confessionais." },
    ]
  }
];
