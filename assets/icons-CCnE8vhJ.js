import{g as Ve}from"./diagrams-D2maJHOX.js";function Ye(f,a){for(var d=0;d<a.length;d++){const p=a[d];if(typeof p!="string"&&!Array.isArray(p)){for(const m in p)if(m!=="default"&&!(m in f)){const h=Object.getOwnPropertyDescriptor(p,m);h&&Object.defineProperty(f,m,h.get?h:{enumerable:!0,get:()=>p[m]})}}}return Object.freeze(Object.defineProperty(f,Symbol.toStringTag,{value:"Module"}))}var K={exports:{}},j={exports:{}};j.exports;var Re;function Ie(){return Re||(Re=1,(function(f,a){/**
 * @license React
